  ...
  if (loading && !data) {
    return (
      <div className="section">
        <span className="helper">Chargement des parametres d&apos;abonnement...</span>
      </div>
    );
  }
  ...
  return (
    <div className="stack">
      ...
      <div className="dashboard-grid">
        <SectionCard title="Abonnement courant">
          {data.subscription ? (
            <div className="list-item">
              <div className="split">
                ...
                <StatusBadge
                  ...
                  tone={data.subscription.status === "ACTIVE" ? "success" : "warn"}
                />
              </div>
        ...
        <SectionCard title="Changer de plan" hint="Migration simple vers un autre abonnement">
          <form
            className="stack"
            onSubmit={(event) => {
